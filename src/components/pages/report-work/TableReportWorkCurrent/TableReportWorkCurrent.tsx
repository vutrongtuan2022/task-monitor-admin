...
function TableReportWorkCurrent({}: PropsTableReportWorkCurrent) {
	...
	const {_id, _page, _pageSize, _keyword, _state} = router.query;

	const {data: listReportLastMonth, isFetching} = useQuery([QUERY_KEY.table_list_work_report, _page, _pageSize, _keyword, _state, _id], {
		queryFn: () =>
			httpRequest({
	...
	return (
		<div className={styles.main_table}>
			...
			<Pagination
				...
				dependencies={[_pageSize, _keyword, _state, _id]}
			/>
		</div>
	);
}
