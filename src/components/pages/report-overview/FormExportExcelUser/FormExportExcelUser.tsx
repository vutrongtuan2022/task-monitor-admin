...
import {PropsFormExportExcelUser} from './interfaces';
import styles from './FormExportExcelUser.module.scss';
...
function FormExportExcelUser({onClose}: PropsFormExportExcelUser) {
...
export default FormExportExcelUser;
